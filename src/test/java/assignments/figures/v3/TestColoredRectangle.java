...
public class TestColoredRectangle {
    ...
    public void testSetWrongColor() {
        try {
            Point topLeft = new Point(10, 20);
            Point bottomRight = new Point(30, 40);
            ColoredRectangle coloredRectangle = new ColoredRectangle(topLeft, bottomRight, "YELLOW");
            fail();
        ...
        try {
            Point topLeft = new Point(10, 20);
            Point bottomRight = new Point(30, 40);
            ColoredRectangle coloredRectangle = new ColoredRectangle(topLeft, bottomRight, (Color) null);
            fail();
        } catch (ColorException ex) {
        ...
        try {
            Point topLeft = new Point(10, 20);
            Point bottomRight = new Point(30, 40);
            ColoredRectangle coloredRectangle = new ColoredRectangle(topLeft, bottomRight, (String) null);
            fail();
        } catch (ColorException ex) {
            assertEquals(ColorErrorCode.NULL_COLOR, ex.getErrorCode());
        }
        try {
            ColoredRectangle coloredRectangle = new ColoredRectangle(10, 20, 30, 40, "YELLOW");
            fail();
        } catch (ColorException ex) {
            assertEquals(ColorErrorCode.WRONG_COLOR_STRING, ex.getErrorCode());
        }
        try {
            ColoredRectangle coloredRectangle = new ColoredRectangle(10, 20, 30, 40, (Color) null);
            fail();
        } catch (ColorException ex) {
            assertEquals(ColorErrorCode.NULL_COLOR, ex.getErrorCode());
        }
        try {
            ColoredRectangle coloredRectangle = new ColoredRectangle(10, 20, 30, 40, (String) null);
            fail();
        } catch (ColorException ex) {
            assertEquals(ColorErrorCode.NULL_COLOR, ex.getErrorCode());
        }
        try {
            ColoredRectangle coloredRectangle = new ColoredRectangle(10, 10, "YELLOW");
            fail();
        } catch (ColorException ex) {
            assertEquals(ColorErrorCode.WRONG_COLOR_STRING, ex.getErrorCode());
        }
        try {
            ColoredRectangle coloredRectangle = new ColoredRectangle(10, 10, (Color) null);
            fail();
        } catch (ColorException ex) {
            assertEquals(ColorErrorCode.NULL_COLOR, ex.getErrorCode());
        }
        try {
            ColoredRectangle coloredRectangle = new ColoredRectangle(10, 10, (String) null);
            fail();
        } catch (ColorException ex) {
            assertEquals(ColorErrorCode.NULL_COLOR, ex.getErrorCode());
        }
    ...
    public void testEqualsColoredRectangle() throws ColorException {
        ...
        assertNotEquals(coloredRectangle1, new Point());
        assertNotEquals(coloredRectangle1, null);
        assertNotEquals(coloredRectangle1, coloredRectangle3);
        assertNotEquals(coloredRectangle3, coloredRectangle4);
