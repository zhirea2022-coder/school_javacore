...
public class TestColoredCircle {
    ...
    public void testSetWrongColor() {
        try {
            ColoredCircle coloredCircle = new ColoredCircle(new Point(0, 20), 10, "YELLOW");
            fail();
        ...
        try {
            ColoredCircle coloredCircle = new ColoredCircle(new Point(0, 20), 10, (Color) null);
            fail();
        } catch (ColorException ex) {
            assertEquals(ColorErrorCode.NULL_COLOR, ex.getErrorCode());
        }
        try {
            ColoredCircle coloredCircle = new ColoredCircle(new Point(0, 20), 10, (String) null);
            fail();
        } catch (ColorException ex) {
            assertEquals(ColorErrorCode.NULL_COLOR, ex.getErrorCode());
        }
        ...
        try {
            ColoredCircle coloredCircle = new ColoredCircle(10, "YELLOW");
            fail();
        } catch (ColorException ex) {
            assertEquals(ColorErrorCode.WRONG_COLOR_STRING, ex.getErrorCode());
        }
        try {
            ColoredCircle coloredCircle = new ColoredCircle(10, (Color) null);
            fail();
        } catch (ColorException ex) {
            assertEquals(ColorErrorCode.NULL_COLOR, ex.getErrorCode());
        }
        try {
            ColoredCircle coloredCircle = new ColoredCircle(10, (String) null);
            fail();
        } catch (ColorException ex) {
            assertEquals(ColorErrorCode.NULL_COLOR, ex.getErrorCode());
        }
    ...
    public void testEqualsColoredCircle() throws ColorException {
        ...
        ColoredCircle coloredCircle6 = new ColoredCircle(new Point(0, 0), 10, Color.GREEN);
        assertEquals(coloredCircle1, coloredCircle2);
        assertNotEquals(coloredCircle1, new Point());
        assertNotEquals(coloredCircle1, null);
        ...
        assertNotEquals(coloredCircle5, coloredCircle6);
    }
