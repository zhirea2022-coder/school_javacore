...
public class TestEllipse {
    ...
    public void testEqualsEllipse() {
        ...
        Ellipse ellipse6 = new Ellipse(new Point(20, 10), 20, 30);
        Ellipse ellipse7 = new Ellipse(new Point(20, 10), 20, 40);
        assertEquals(ellipse1, ellipse1);
        assertEquals(ellipse1, ellipse2);
        assertEquals(ellipse1, ellipse3);
        assertNotEquals(ellipse1, null);
        assertNotEquals(ellipse1, new Point());
        assertNotEquals(ellipse1, ellipse4);
        assertNotEquals(ellipse1, ellipse5);
        assertNotEquals(ellipse5, ellipse6);
        assertNotEquals(ellipse6, ellipse7);
    }
